        ...
        <ul class="nav nav-tabs">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a tabindex="-1" href="#Vos disponibilite">Vos disponibilités</a></li>
                    <li><a tabindex="-1" href="#Remuneration">Remuneration</a></li>
                    <li class="divider"></li>
                    <li><a tabindex="-1" href="#">Connexion</a></li>
                </ul >
            </li>
            <li class="divider"></li>
            <li class="dropdown pull-right"">
                ...
                <ul class="dropdown-menu">
                    <li><a tabindex="-1" href="#">Vous avez un projet</a></li>
                    <li><a tabindex="-1" href="#">Nos compétence</a></li>
                    <li><a tabindex="-1" href="#">Tarifs</a></li>
                    <li class="divider"></li>
                    <li><a tabindex="-1" href="#">Connexion</a></li>
                </ul >
            </li>
